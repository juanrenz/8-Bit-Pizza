        ...
        for (let i = 0; i < productos.length; i++) {
            $("#principal").append( `<div class="principal__cards__contenedor">
                            <div class="card" style="width: 23rem;">
                                ...
                                <a href="javascript:void(0)" id=boton${productos[i].id} onclick="agregarAlCarrito(${productos[i].id}), alertify.success('Agregado!');" class="eightbit-btn eightbit-btn--proceed">Agregar</a>
                            </div>
                        </div>`)
        };
    }
