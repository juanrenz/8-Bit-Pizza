...
for (let i = 0; i < productos.length; i++) {
    ...
    contenedor.className = "principal__cards"

    contenedor.innerHTML += `<div class="principal__cards__contenedor">
    ...
    var prueba = document.getElementsByTagName("section")[i];
    console.log(prueba)
    prueba.appendChild(contenedor)
}
